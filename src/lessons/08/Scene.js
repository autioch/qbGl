...
const scene = new Lib.Scene('webgl08');
...
const container = document.getElementById('container08');
...
function handleKeyDown(event) {
  ...
  if (String.fromCharCode(event.keyCode) == 'F') {
    ...
    document.getElementById('tooltip08').textContent = `Filter: ${cube.filter}`;
  }
}
